...
import com.castsoftware.aip.console.tools.core.exceptions.InvalidVersionException;
...
/**
 * Object representing a version composed of 2 to 4 numbers separated by a dot.
 */
public final class VersionInformation {
     ...
     */
    private static void assertVersionCoherence(int major, int minor, int maintenance, int build) {
     ...
     */
    public VersionInformation(int major, int minor, int maintenance, int build, String productVersionString) {
     ...
     * @param maintenance The version maintenance number.
     */
    public VersionInformation(int major, int minor, int maintenance) {
     ...
     */
    public static VersionInformation fromString(String s) {
