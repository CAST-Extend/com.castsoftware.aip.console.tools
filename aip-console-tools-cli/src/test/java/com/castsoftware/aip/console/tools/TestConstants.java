...
public final class TestConstants {
    public static final String TEST_CREATE_APP = "To_Create_App-name";
    ...
    // OBR: OnBoard application
    public static final String TEST_OBR_VERSION_NAME = "My version";
    public static final String TEST_OBR_VERSION_GUID = "OBR-G-U-I-D";
    ...
    public static final ApplicationDto TEST_APP = ApplicationDto.builder().guid(TEST_APP_GUID).name(TEST_CREATE_APP).caipVersion("8.3.99").build();
}
