...
On this page, go to the **CAST Imaging global configuration** section and enter the following required elements :

* *CAST Imaging URL* : The URL to access the CAST Imaging server. Make sure that this address is accessible from the
...
### Using different CAST Imaging URL and API Key
...
![Step specific CAST Imaging URL and API Key configuration](./doc/images/custom_URL_ApiKey.png)

The CAST Imaging URL and associated API Key specified in the step details will always be used when running a step. In case they are left empty, the global configuration will be used instead.
...
* *CAST Imaging URL*: URL to CAST Imaging should you want to target a different instance that the one specified
